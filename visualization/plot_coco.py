...
def plot(data, gt_file, img_path, save_path, 
         link_pairs, ring_color, format, save=True):
    ...
    for catId in catIds:
        for imgId in p.imgIds[:8154]:
            ...
            # Read Images
            img_file = img_path + img_name + format
...
if __name__ == '__main__':
    ...
    plot(data, gt_file, img_path, save_path, colorstyle.link_pairs, colorstyle.ring_color, args.format, save=True)
